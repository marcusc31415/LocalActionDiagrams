...
#!         Func="SetLocalActionDiagramDegreeTwoVertexBound"/> function. 
#!     </Description>
#! </ManSection>
#!
#! @BeginLogSession
...
#! <ManSection>
#!     <Oper Name="SetLocalActionDiagramDegreeTwoVertexBound" Arg="bound"/>
#!     <Description>
...
#! <ManSection>
#!     <Oper Name="LocalActionDiagramDebugSearch" Arg="debug"/>
#!     <Description>
