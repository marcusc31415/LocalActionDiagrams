...
InstallMethod(LAD_Internal_LocalActionDiagramsEnumerate@, "enumerates local action diagrams up to isomorphism", [IsInt, IsInt],
function(degree, no_verts)
	...
	# RSGraphFromLibrary function to use pre-computed data
...
InstallMethod(LAD_Internal_RSGraphsEnumerate@, "Enumerate RS Graphs with valency <= d and n vertices", [IsInt, IsInt],
function(degree, no_verts)
